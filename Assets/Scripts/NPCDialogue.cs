...
public class NPCDialogue : MonoBehaviour
{
    ...
    public void PlayDialogue()
    {
        ...
        else if (playingResponse == false)
        {
            ...
            while (playerFlags[dialogue.conversations[conversationNumber].requiredFlag] == false || (playerFlags[dialogue.conversations[conversationNumber].skipFlag] == true && dialogue.conversations[conversationNumber].skipFlag != "None"))
            {
                conversationNumber++;
